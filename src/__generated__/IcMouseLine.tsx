...
export const IcMouseLine = ({ ref, ...props }: IconProps) => {
  return (
    <IconBase ref={ref} viewBox="0 0 24 24" {...props}>
      ...
      />
      <path
        d="M12 6.25001C11.5881 6.2554 11.2554 6.58805 11.25 7.00001V12C11.25 12.4142 11.5858 12.75 12 12.75C12.4142 12.75 12.75 12.4142 12.75 12V7.00001C12.7446 6.58805 12.412 6.2554 12 6.25001Z"
        xmlns="http://www.w3.org/2000/svg"
      />
    </IconBase>
  );
...
IcMouseLine.displayName = 'IcMouseLine';
