...
export const IcVolumeDownFilled = ({ ref, ...props }: IconProps) => {
  return (
    <IconBase ref={ref} viewBox="0 0 24 24" {...props}>
      <path
        d="M21.7203 11.2501H16.8803C16.4661 11.2501 16.1303 11.5858 16.1303 12.0001C16.1303 12.4143 16.4661 12.7501 16.8803 12.7501H21.7203C22.1345 12.7501 22.4703 12.4143 22.4703 12.0001C22.4703 11.5858 22.1345 11.2501 21.7203 11.2501Z"
...
IcVolumeDownFilled.displayName = 'IcVolumeDownFilled';
